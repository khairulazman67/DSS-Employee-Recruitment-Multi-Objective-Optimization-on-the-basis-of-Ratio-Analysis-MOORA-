...
$sql       = "SELECT * FROM kriteriaWawancara WHERE id = '$id'";
                ...
                <div class="col-xl-12  col-lg-8">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 class="m-0 font-weight-bold text-info"> <b> Ubah Data Kriteria Wawancara </b></h5>
                        </div>
                        <div class="card-body">
                            <form class="form" method="post">
                                <div class="form-group">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12">ID Wawancara</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12">Jumlah Nilai
                                        Psikotest</label>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input class="form-control" type="text" name="jumlahNilai"
                                            value="<?php echo $row['jumlahNilai']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    $query = "UPDATE kriteriaWawancara SET jumlahNilai = '$jumlahNilai', bilanganfuzzy = '$bilfuzzy', nilai = '$nilai' WHERE id = '$id'";
