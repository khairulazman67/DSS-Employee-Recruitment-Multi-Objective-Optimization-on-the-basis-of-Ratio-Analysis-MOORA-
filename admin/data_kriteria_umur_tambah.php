...
<?php
$sql    = "SELECT id FROM kriteriaUmur";
        ...
        <div class="col-xl-12  col-lg-8">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h5 class="m-0 font-weight-bold text-info"> <b> Tambah Kriteria Umur </b></h5>
            </div>
            <div class="card-body">
...
if (isset($_POST['simpan'])) {
  ...
  $query = "INSERT INTO kriteriaUmur (id, umur, bilanganfuzzy, nilai) VALUES ('$id_umur','$umur','$fuzzy','$nilai')";
