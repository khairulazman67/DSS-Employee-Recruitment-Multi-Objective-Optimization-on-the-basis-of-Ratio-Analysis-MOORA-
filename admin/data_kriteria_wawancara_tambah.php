...
<?php
$sql    = "SELECT id FROM kriteriaWawancara";
                ...
                <div class="col-xl-12  col-lg-8">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 class="m-0 font-weight-bold text-info"> <b> Tambah Kriteria Daya Wawancara </b></h5>
                        </div>
                        <div class="card-body">
                            <form class="form" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12"> Jumlah Nilai Wawancara
                                    </label>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO kriteriaWawancara (id, jumlahNilai, bilanganfuzzy, nilai) VALUES ('$id','$jumlahNilai','$fuzzy','$nilai')";
