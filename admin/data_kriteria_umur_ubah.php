...
<?php
$id  = $_GET['id'];
$sql       = "SELECT * FROM kriteriaUmur WHERE id = '$id'";
            ...
            <div class="card-body">
              <form class="form" method="post">
                <div class="form-group">
                  <label class="control-label col-md-12 col-sm-12 col-xs-12">ID Umur</label>
...
if (isset($_POST['simpan'])) {
  ...
  $query = "UPDATE kriteriaUmur SET umur = '$umur', bilanganfuzzy = '$bilfuzzy', nilai = '$nilai' WHERE id = '$id'";
