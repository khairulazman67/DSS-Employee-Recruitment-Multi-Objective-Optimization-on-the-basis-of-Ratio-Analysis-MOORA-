...
<?php
$sql    = "SELECT id FROM kriteriaIPK";
        ...
        <div class="col-xl-12  col-lg-8">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h5 class="m-0 font-weight-bold text-info"> <b> Tambah Kriteria IPK </b></h5>
            </div>
            <div class="card-body">
              <form class="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="number" step="0.01" name="IPK" required>
                  </div>
                </div>
                <div class="form-group">
...
if (isset($_POST['simpan'])) {
  ...
  $query = "INSERT INTO kriteriaIPK (id, IPK, bilanganfuzzy, nilai) VALUES ('$id','$IPK','$fuzzy','$nilai')";
